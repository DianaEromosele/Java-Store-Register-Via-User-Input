...
class Receipt {
	...
	public Boolean validPriceFormat(String userInput) {
	...
	public void addItemToReceipt(String productDescription, Double productPrice) {
		Item product = new Item(productDescription, productPrice);
	...
	public void displayFinalReceipt(){
		...
		System.out.println( this.getItemsArray().get(index).getDescription() + ": " + this.getFinalPricesArray().get(index) );
		}
